...

{
    ...
    "title": "Bit twiddling",
    "category": "section",
    "text": "popcount(::fmpz)prevpow2(::fmpz)nextpow2(::fmpz)trailing_zeros(::fmpz)clrbit!(::fmpz, ::Int)setbit!(::fmpz, ::Int)combit!(::fmpz, ::Int)Examplea = fmpz(12)\n\np = popcount(a)\nb = nextpow2(a)\ncombit!(a, 2)"
},
