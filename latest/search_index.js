...
{
    "location": "about.html#About-Nemo-1",
    "page": "About Nemo",
    "title": "About Nemo",
    "category": "section",
...

{
    ...
    "category": "section",
    "text": "Nemo integers implement the whole of the ring and Euclidean ring interfaces of AbstractAlgebra.jl.https://nemocas.github.io/AbstractAlgebra.jl/latest/ringshttps://nemocas.github.io/AbstractAlgebra.jl/latest/euclidean.Below, we describe the functionality that is specific to the Nemo/Flint integer ring."
},
...
{
    "location": "integer.html#Shifting-1",
    "page": "Integers",
    "title": "Shifting",
    "category": "section",
...
{
    "location": "integer.html#Integer-logarithm-1",
    "page": "Integers",
...
{
    "location": "integer.html#Integer-roots-1",
    "page": "Integers",
    "title": "Integer roots",
    "category": "section",
...
{
    "location": "integer.html#Base.factorial-Tuple{fmpz}",
    "page": "Integers",
    "title": "Base.factorial",
    "category": "method",
    "text": "factorial(x::fmpz)\n\nReturn the factorial of x, i.e. x = 123ldots x. We require x geq 0.\n\n\n\n"
},

{
    "location": "integer.html#Nemo.rising_factorial-Tuple{fmpz,fmpz}",
    "page": "Integers",
...
{
    "location": "integer.html#Nemo.fibonacci-Tuple{fmpz}",
    "page": "Integers",
    "title": "Nemo.fibonacci",
    "category": "method",
...
{
    "location": "integer.html#Base.binomial-Tuple{fmpz,fmpz}",
    "page": "Integers",
    "title": "Base.binomial",
    "category": "method",
    "text": "binomial(n::fmpz, k::fmpz)\n\nReturn the binomial coefficient fracn(n - k)k. If n k  0 or k  n we return 0.\n\n\n\n"
},

{
    "location": "integer.html#Nemo.moebius_mu-Tuple{Int64}",
    "page": "Integers",
...
{
    "location": "integer.html#Nemo.divisor_sigma-Tuple{Int64,Int64}",
    "page": "Integers",
...
{
    "location": "integer.html#Nemo.divisor_sigma-Tuple{fmpz,fmpz}",
    "page": "Integers",
    "title": "Nemo.divisor_sigma",
    "category": "method",
...
{
    "location": "integer.html#Nemo.euler_phi-Tuple{Int64}",
    "page": "Integers",
...
{
    "location": "integer.html#Nemo.number_of_partitions-Tuple{Int64}",
    "page": "Integers",
    "title": "Nemo.number_of_partitions",
    "category": "method",
    "text": "number_of_partitions(x::Int)\n\nReturn the number of partitions of x. This function is not available on Windows 64.\n\n\n\n"
},

{
    "location": "integer.html#Nemo.number_of_partitions-Tuple{fmpz}",
    "page": "Integers",
    "title": "Nemo.number_of_partitions",
    "category": "method",
    "text": "number_of_partitions(x::fmpz)\n\nReturn the number of partitions of x. This function is not available on Windows 64.\n\n\n\n"
},
...
{
    "location": "integer.html#Digits-and-bases-1",
    "page": "Integers",
...
{
    "location": "integer.html#Bit-twiddling-1",
    "page": "Integers",
    "title": "Bit twiddling",
    "category": "section",
...
{
    "location": "polynomial.html#Univariate-polynomials-1",
    "page": "Univariate polynomials",
    "title": "Univariate polynomials",
    "category": "section",
    "text": ""
...
{
    "location": "polynomial.html#Introduction-1",
    "page": "Univariate polynomials",
    "title": "Introduction",
    "category": "section",
...
{
    "location": "polynomial.html#Remove-and-valuation-1",
    "page": "Univariate polynomials",
...
{
    "location": "polynomial.html#Signature-1",
    "page": "Univariate polynomials",
    "title": "Signature",
    "category": "section",
...
{
    "location": "polynomial.html#Root-finding-1",
    "page": "Univariate polynomials",
    "title": "Root finding",
    "category": "section",
...
{
    "location": "polynomial.html#Construction-from-roots-1",
    "page": "Univariate polynomials",
...
{
    "location": "polynomial.html#Bounding-absolute-values-of-roots-1",
    "page": "Univariate polynomials",
...
{
    "location": "polynomial.html#Overlapping-and-containment-1",
    "page": "Univariate polynomials",
...
{
    "location": "polynomial.html#Factorisation-1",
    "page": "Univariate polynomials",
    "title": "Factorisation",
    "category": "section",
...

{
    ...
    "title": "Polynomial functionality",
    "category": "section",
    "text": "All multivariate polynomial types in Nemo follow the AbstractAlgebra.jl multivariate polynomial interface:https://nemocas.github.io/AbstractAlgebra.jl/latest/mpolynomial_ringsGeneric multivariate polynomials are also available, and Nemo multivariate polynomial types also implement all of the same functionality.https://nemocas.github.io/AbstractAlgebra.jl/latest/mpolynomial.We describe here only functions that are in addition to that guaranteed by AbstractAlgebra.jl, for specific coefficient rings."
},
...
{
    "location": "series.html#Power-series-and-Laurent-series-1",
    "page": "Power series and Laurent series",
    "title": "Power series and Laurent series",
    "category": "section",
...
{
    "location": "series.html#Capped-relative-power-series-1",
    "page": "Power series and Laurent series",
...
{
    "location": "series.html#Capped-absolute-power-series-1",
    "page": "Power series and Laurent series",
...
{
    "location": "series.html#Power-series-functionality-1",
    "page": "Power series and Laurent series",
    "title": "Power series functionality",
    "category": "section",
    "text": "Power series rings in Nemo implement the AbstractAlgebra.jl series interface:https://nemocas.github.io/AbstractAlgebra.jl/latest/series_ringsIn addition, generic power series and Laurent series are provided by AbstractAlgebra.jl:https://nemocas.github.io/AbstractAlgebra.jl/latest/seriesPower series rings in Nemo also implement this generic functionality. We list below only the functionality that differs from this generic functionality, for specific rings provided by Nemo."
},
...

{
    ...
    "category": "section",
    "text": "Puiseux series rings in Nemo implement the AbstractAlgebra.jl series interface, with the exception of the pol_length and polcoeff functions:https://nemocas.github.io/AbstractAlgebra.jl/latest/series_ringsIn addition, generic Puiseux series are provided by AbstractAlgebra.jl:https://nemocas.github.io/AbstractAlgebra.jl/latest/puiseux.Puiseux series rings in Nemo also implement this generic functionality. We list below only the functionality that differs from this generic functionality, for specific rings provided by Nemo."
},
...
{
    "location": "residue.html#Residue-rings-1",
    "page": "Residue rings",
    "title": "Residue rings",
    "category": "section",
...
{
    "location": "residue.html#Residue-functionality-1",
    "page": "Residue rings",
    "title": "Residue functionality",
    "category": "section",
    "text": "All the residue rings in Nemo implement the residue ring interface of AbstractAlgebra.jl:https://nemocas.github.io/AbstractAlgebra.jl/latest/residue_ringsIn addition, functionality for generic residue rings is available:https://nemocas.github.io/AbstractAlgebra.jl/latest/residueThe other residue types in Nemo also implement this functionality."
},
...
{
    "location": "fraction.html#Fraction-fields-1",
    "page": "Fraction fields",
    "title": "Fraction fields",
    "category": "section",
...
{
    "location": "fraction.html#Fraction-functionality-1",
    "page": "Fraction fields",
    "title": "Fraction functionality",
    "category": "section",
    "text": "All fraction types in Nemo implement the AbstractAlgebra.jl fraction field interface:https://nemocas.github.io/AbstractAlgebra.jl/latest/fraction_fieldsIn addition, generic fractions fields are implemented in AbstractAlgebra.jl, with the following functionality:https://nemocas.github.io/AbstractAlgebra.jl/latest/fractionAll fraction types in Nemo also implement this generic functionality."
},
...
{
    "location": "fraction.html#Base.floor-Tuple{fmpq}",
    "page": "Fraction fields",
    "title": "Base.floor",
    "category": "method",
    "text": "floor(a::fmpq)\n\nReturns the greatest integer that is less than or equal to a. The result is returned as a rational with denominator 1.\n\n\n\n"
},

{
    "location": "fraction.html#Base.ceil-Tuple{fmpq}",
    "page": "Fraction fields",
    "title": "Base.ceil",
    "category": "method",
...
{
    "location": "fraction.html#Basic-manipulation-1",
    "page": "Fraction fields",
    "title": "Basic manipulation",
    "category": "section",
...
{
    "location": "fraction.html#Modular-arithmetic-1",
    "page": "Fraction fields",
    "title": "Modular arithmetic",
    "category": "section",
...
{
    "location": "fraction.html#Rational-Reconstruction-1",
    "page": "Fraction fields",
...

{
    ...
    "category": "method",
    "text": "next_signed_minimal(a::fmpq)\n\nGiven a signed rational number a assumed to be in canonical form, returns the next element in the minimal-height sequence generated by next_minimal but with negative numbers interleaved. The sequence begins 0 1 -1 12 -12 2 -2 13 -13 ldots. Starting with zero, this generates every rational number once and only once, in order of minimal height.\n\n\n\n"
},

{
    ...
    "category": "method",
    "text": "next_calkin_wilf(a::fmpq)\n\nGiven a return the next number in the breadth-first traversal of the Calkin-Wilf tree. Starting with zero, this generates every nonnegative rational number once and only once, with the first few entries being 0 1 12 2 13 32 23 3 14 43 35 52 25 ldots. Despite the appearance of the initial entries, the Calkin-Wilf enumeration does not produce the rational numbers in order of height: some small fractions will appear late in the sequence. This order has the advantage of being faster to produce than the minimal-height order.\n\n\n\n"
},
...
{
    "location": "fraction.html#Rational-enumeration-1",
    "page": "Fraction fields",
...
{
    "location": "rational.html#Rationals-1",
    "page": "Rationals",
    "title": "Rationals",
    "category": "section",
...
{
    "location": "arb.html#Real-balls-1",
    "page": "Real balls",
    "title": "Real balls",
    "category": "section",
...
{
    "location": "arb.html#Real-ball-functionality-1",
    "page": "Real balls",
    "title": "Real ball functionality",
    "category": "section",
    "text": "Real balls in Nemo implement the full AbstractAlgebra.jl field interface.https://nemocas.github.io/AbstractAlgebra.jl/latest/fieldsBelow, we document the additional functionality provided for real balls."
},

{
    "location": "arb.html#Constructors-1",
    "page": "Real balls",
    "title": "Constructors",
    "category": "section",
...
{
    "location": "arb.html#Real-ball-constructors-1",
    "page": "Real balls",
...
{
    "location": "arb.html#Conversions-1",
    "page": "Real balls",
    "title": "Conversions",
    "category": "section",
...
{
    "location": "arb.html#Basic-manipulation-1",
    "page": "Real balls",
    "title": "Basic manipulation",
    "category": "section",
...
{
    "location": "arb.html#Containment-1",
    "page": "Real balls",
    "title": "Containment",
    "category": "section",
...
{
    "location": "arb.html#Comparison-1",
    "page": "Real balls",
    "title": "Comparison",
    "category": "section",
...
{
    "location": "arb.html#Absolute-value-1",
    "page": "Real balls",
...
{
    "location": "arb.html#Miscellaneous-operations-1",
    "page": "Real balls",
...
{
    "location": "arb.html#Mathematical-and-special-functions-1",
    "page": "Real balls",
...
{
    "location": "acb.html#Complex-balls-1",
    "page": "Complex balls",
    "title": "Complex balls",
    "category": "section",
...
{
    "location": "acb.html#Complex-ball-functionality-1",
    "page": "Complex balls",
    "title": "Complex ball functionality",
    "category": "section",
    "text": "The complex balls in Nemo implement the AbstractAlgebra.jl field interface.https://nemocas.github.io/AbstractAlgebra.jl/latest/fieldsBelow, we document the additional functionality provided for complex balls."
},

{
    "location": "acb.html#Complex-field-constructors-1",
    "page": "Complex balls",
...
{
    "location": "acb.html#Constructors-1",
    "page": "Complex balls",
    "title": "Constructors",
    "category": "section",
...
{
    "location": "acb.html#Basic-functionality-1",
    "page": "Complex balls",
...
{
    "location": "acb.html#Basic-manipulation-1",
    "page": "Complex balls",
    "title": "Basic manipulation",
    "category": "section",
...
{
    "location": "acb.html#Containment-1",
    "page": "Complex balls",
    "title": "Containment",
    "category": "section",
...
{
    "location": "acb.html#Comparison-1",
    "page": "Complex balls",
    "title": "Comparison",
    "category": "section",
...
{
    "location": "acb.html#Absolute-value-1",
    "page": "Complex balls",
    "title": "Absolute value",
    "category": "section",
...
{
    "location": "acb.html#Miscellaneous-operations-1",
    "page": "Complex balls",
    "title": "Miscellaneous operations",
    "category": "section",
...
{
    "location": "acb.html#Mathematical-and-special-functions-1",
    "page": "Complex balls",
    "title": "Mathematical and special functions",
    "category": "section",
...

{
    ...
    "category": "section",
    "text": "Galois fields in Nemo implement the residue ring interface of AbstractAlgebra.jl:https://nemocas.github.io/AbstractAlgebra.jl/latest/residue_ringsIn addition, all the functionality for generic residue rings is available:https://nemocas.github.io/AbstractAlgebra.jl/latest/residueBelow we describe the functionality that is provided in addition to this interface."
},
...
{
    "location": "finitefield.html#Finite-fields-1",
    "page": "Finite fields",
    "title": "Finite fields",
    "category": "section",
...
{
    "location": "finitefield.html#Basic-manipulation-1",
    "page": "Finite fields",
    "title": "Basic manipulation",
    "category": "section",
...
{
    "location": "finitefield.html#Special-functions-1",
    "page": "Finite fields",
    "title": "Special functions",
    "category": "section",
...
{
    "location": "numberfield.html#Number-field-arithmetic-1",
    "page": "Number field arithmetic",
    "title": "Number field arithmetic",
    "category": "section",
...
{
    "location": "numberfield.html#Number-field-functionality-1",
    "page": "Number field arithmetic",
    "title": "Number field functionality",
    "category": "section",
    "text": "The number fields in Nemo implement the full AbstractAlgebra.jl field interface.https://nemocas.github.io/AbstractAlgebra.jl/latest/fieldsBelow, we document the additional functionality provided for number field elements."
},

{
    "location": "numberfield.html#Constructors-1",
    "page": "Number field arithmetic",
    "title": "Constructors",
    "category": "section",
...
{
    "location": "numberfield.html#Number-field-element-constructors-1",
    "page": "Number field arithmetic",
...
{
    "location": "numberfield.html#Basic-functionality-1",
    "page": "Number field arithmetic",
    "title": "Basic functionality",
    "category": "section",
...
{
    "location": "padic.html#P-adic-functionality-1",
    "page": "Padics",
    "title": "P-adic functionality",
    "category": "section",
    "text": "P-adic fields in Nemo implement the AbstractAlgebra.jl field interface.https://nemocas.github.io/AbstractAlgebra.jl/latest/fieldsBelow, we document all the additional function that is provide by Nemo for p-adic fields."
},
...
{
    "location": "padic.html#Constructors-1",
    "page": "Padics",
    "title": "Constructors",
    "category": "section",
...
{
    "location": "padic.html#Big-oh-notation-1",
    "page": "Padics",
...
{
    "location": "padic.html#Basic-manipulation-1",
    "page": "Padics",
    "title": "Basic manipulation",
    "category": "section",
...
{
    "location": "padic.html#Square-root-1",
    "page": "Padics",
    "title": "Square root",
    "category": "section",
...
{
    "location": "padic.html#Special-functions-1",
    "page": "Padics",
    "title": "Special functions",
    "category": "section",
...

{
    ...
    "title": "P-adic functionality",
    "category": "section",
    "text": "Q-adic fields in Nemo implement the AbstractAlgebra.jl field interface.https://nemocas.github.io/AbstractAlgebra.jl/latest/fieldsBelow, we document all the additional function that is provide by Nemo for p-adic fields."
},
...
{
    "location": "matrix.html#Comparison-operators-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Pseudo-inverse-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Modular-reduction-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Special-matrices-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Smith-Normal-Form-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Gram-Schmidt-Orthogonalisation-1",
    "page": "Matrices",
...
{
    "location": "matrix.html#Exponential-1",
    "page": "Matrices",
    "title": "Exponential",
    "category": "section",
...
{
    "location": "matrix.html#Shifting-1",
    "page": "Matrices",
    "title": "Shifting",
    "category": "section",
...
{
    "location": "matrix.html#Predicates-1",
    "page": "Matrices",
    "title": "Predicates",
    "category": "section",
...
{
    "location": "matrix.html#Conversion-to-Julia-matrices-1",
    "page": "Matrices",
...
{
    "location": "factor.html#Factorisation-1",
    "page": "Factorisation",
    "title": "Factorisation",
    "category": "section",
...
{
    "location": "factor.html#Base.in-Tuple{fmpz,Fac{fmpz}}",
    "page": "Factorisation",
    "title": "Base.in",
    "category": "method",
...
{
    "location": "factor.html#Base.getindex-Tuple{Fac{fmpz},fmpz}",
    "page": "Factorisation",
    "title": "Base.getindex",
    "category": "method",
    "text": "getindex(a::Fac, b) -> Int\n\nIf b is a factor of a, the corresponding exponent is returned. Otherwise an error is thrown.\n\n\n\n"
},

{
    "location": "factor.html#Base.length-Tuple{Fac{fmpz}}",
    "page": "Factorisation",
    "title": "Base.length",
    "category": "method",
...
{
    "location": "factor.html#AbstractAlgebra.unit-Tuple{Fac{fmpz}}",
    "page": "Factorisation",
...
{
    "location": "factor.html#Basic-functionality-1",
    "page": "Factorisation",
    "title": "Basic functionality",
    "category": "section",
    "text": "Objects of type Fac are iterable, that is, if a is an object of type Fac, then for (p, e) in a will iterate through all pairs (p, e), where p is a factor and e the corresponding exponent.in(::fmpz, ::Fac{fmpz})\ngetindex(::Fac{fmpz}, ::fmpz)\nlength(::Fac{fmpz})\nunit(::Fac{fmpz})"
},
